...
public class TokenInThreadTest {
    ...
    public void testAddTokens() {
        ...
        t1.setPosition(0);
        t2.setTerm("a");
        t2.setRank(100); // their rank should be same, since they are same term in different position
        t2.setUrl("a.com");
        t2.setPosition(1);
        ...
        Assert.assertEquals((long) 100, (long) tokenInThread.getRank());
        ...
        Assert.assertEquals("a.com;100;0,1",tokenInThread.toInfo());
    }
}
